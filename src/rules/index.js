...
import text_several_h1 from "./text-several-h1";
import text_invalid_h2_position from "./text-invalid-h2-position";
import text_invalid_h3_position from "./text-invalid-h3-position";
import warning_text_sizes_should_be_equal from "./warning-text-sizes-should-be-equal";
...
export default [
  text_several_h1,
  text_invalid_h2_position,
  text_invalid_h3_position,
